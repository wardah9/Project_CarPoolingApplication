...
import carpoolingapplication.carpooling.com.MainActivity;
import carpoolingapplication.carpooling.com.R;
import carpoolingapplication.carpooling.com.classes.DataParser;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private double P_Latitude = 0.0;
    private double P_Longitude = 0.0;
        ...
        */
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                Log.i("search_place", "Place: " + place.getName());
            ...
            public void onError(Status status) {
                ...
                Log.i("search_place", "An error occurred: " + status);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PLACE_AUTOCOMPLETE_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                Log.i("search_place", "Place:" + place.toString());
            } else if (resultCode == PlaceAutocomplete.RESULT_ERROR) {
                Status status = PlaceAutocomplete.getStatus(this, data);
                Log.i("search_place", status.getStatusMessage());
